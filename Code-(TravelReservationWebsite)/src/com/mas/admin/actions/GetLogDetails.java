...
public class GetLogDetails extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
        	flist=new MasterDAO().getLoginDetails();
        }catch (Exception e) {
			 e.printStackTrace();
        ...
        if(flist!=null){
        	request.getSession().setAttribute("logdetails", flist);
        }
        
        RequestDispatcher rd=request.getRequestDispatcher("./ViewLogDetails.jsp");
